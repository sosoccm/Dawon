...
<input type=hidden name=TempJob value="card:virtual">
			...
			<tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td colspan=2><input type=text style=width:300px name=StoreNm value="다원애드"></td>
					</tr>
					<tr>
						<td class=clsleft>☞ 상품명 (300)</td>
						<td colspan=2><input type=text style=width:300px name=ProdNm maxlength=300 value="-"></td>
					</tr>
					<tr>
						<td class=clsleft>☞ 상점URL (50)</td>
						<!-- 주의) 상점홈페이지주소를 반드시 입력해 주십시오. -->
						<!-- (미입력시 특정 카드사 신용카드 결제 및 가상계좌 결제가 이뤄지지 않을 수 있습니다.) -->
						<td><input type=hidden style=width:300px name=MallUrl value="http://dawonad.com"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=text style=width:300px name=SubjectData value="업체명;판매상품;계산금액;;"></td>
